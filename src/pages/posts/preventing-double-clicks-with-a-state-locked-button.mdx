...
pubDate: 2026.01.09
description: "How to effectively prevent duplicate form submissions and redundant API calls by encapsulating loading states into a reusable Vue button component, moving beyond simple throttling."
tags: ["Frontend", "Vue.js", "Hook"]
---

Our company website has a recurring issue: when users do not receive immediate feedback after clicking a button, they often click it again.
This results in duplicate submissions on pages such as login and order forms, leading to data inconsistencies and a degraded user experience.
The problem also affects download buttons, where repeated clicks can trigger multiple downloads at the same time, unnecessarily consuming server resources.
